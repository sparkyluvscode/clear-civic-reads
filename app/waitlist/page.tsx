...
export const metadata: Metadata = {
  title: "ClearPolicy — Plain-English, cited explanations of ballot measures",
  description:
  ...
  keywords: [
    ...
    "bill summary",
    "voter guide with sources",
    "non-partisan civic info",
    "policy explanation",
    "legislative analysis",
  ],
  authors: [{ name: "ClearPolicy" }],
  openGraph: {
    title: "ClearPolicy — Plain-English, cited explanations of ballot measures",
    description:
      "Understand bills and ballot measures in minutes. ClearPolicy gives plain-English summaries with citations you can verify.",
    type: "website",
    siteName: "ClearPolicy",
  },
  twitter: {
